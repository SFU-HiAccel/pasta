...
from autobridge.Floorplan.Utilities import (
  ...
  get_four_way_partition_slots_other,
  get_actual_usage,
)
...
def get_floorplan(
  ...
  # if board is u50
  #if slot_manager.board.NAME == 'U50':
  #  final_v2s = iterative_bipartition(init_v2s, slot_manager, grouping_constraints, pre_assignments, partition_order=[Dir.horizontal, Dir.vertical])
  #  if final_v2s:
  #    return final_v2s, get_four_way_partition_slots_other(slot_manager)
