...
class DeviceBase:
  ...
  def _getPblockArea(self, pblock_def):
    ...
    UR_x = min(self.CR_NUM_HORIZONTAL-1, UR_x) 
    ...
    for ip_pblock in self.pre_existing_area:
      ...
      if overlap_pblock:
        ...
        for item in slot_user_area.keys():
          ...
          if slot_user_area[item] < 1:
            slot_user_area[item] = 1
...
class DeviceU200(DeviceBase):
  NAME = 'U200'
  FPGA_PART_NAME = 'xcu200-fsgd2104-2-e'

  SLR_NUM = 4
  CR_NUM_HORIZONTAL = 6
  CR_NUM_VERTICAL = 15
  CR_NUM_VERTICAL_PER_SLR = 5

  TOTAL_AREA = {}
  TOTAL_AREA['BRAM']  = 4320 
  TOTAL_AREA['DSP']   = 6840
  TOTAL_AREA['FF']    = 2364480
  TOTAL_AREA['LUT']   = 1182240
  TOTAL_AREA['URAM']  = 960

  VITIS_REGION = f'CLOCKREGION_X3Y5:CLOCKREGION_X5Y9'

  def _getVitisRegions(self, ddr_list, is_vitis_enabled):
    assert all(ddr in [0, 1, 2, 3] for ddr in ddr_list), f"ERROR In instantiating U200: DDR list provided was {ddr_list}" # U200 has 4 ddrs.

    # The area used by implicit IPs
    pre_existing_area = []
    for ddr in ddr_list:
      pre_existing_area.append(f'{self.DDR_TO_CLOCK_REGIONS[ddr]}')

    if is_vitis_enabled:
      pre_existing_area.append(self.VITIS_REGION)

    return pre_existing_area

  # DDR_TO_CLOCK_REGIONS = {
  #   3 : 'CLOCKREGION_X4Y11:CLOCKREGION_X4Y13',
  #   2 : 'CLOCKREGION_X2Y7:CLOCKREGION_X2Y9',
  #   1 : 'CLOCKREGION_X4Y6:CLOCKREGION_X4Y8',
  #   0 : 'CLOCKREGION_X2Y1:CLOCKREGION_X2Y3',
  # }
  DDR_TO_CLOCK_REGIONS = {
    3 : 'CLOCKREGION_X4Y11:CLOCKREGION_X4Y13',
    2 : 'CLOCKREGION_X1Y5:CLOCKREGION_X1Y9',
    1 : 'CLOCKREGION_X4Y6:CLOCKREGION_X4Y8',
    0 : 'CLOCKREGION_X2Y1:CLOCKREGION_X2Y3',
  }
  ...
  # Clock Region level
  CR_AREA = defaultdict(lambda: defaultdict(dict))
  CR_AREA[0][0 ]['FF'] = 27840
  CR_AREA[0][1 ]['FF'] = 29760
  CR_AREA[0][2 ]['FF'] = 29760
  CR_AREA[0][3 ]['FF'] = 29760
  CR_AREA[0][4 ]['FF'] = 27840
  CR_AREA[0][5 ]['FF'] = 27840
  CR_AREA[0][6 ]['FF'] = 29760
  CR_AREA[0][7 ]['FF'] = 29760
  CR_AREA[0][8 ]['FF'] = 29760
  CR_AREA[0][9 ]['FF'] = 27840
  CR_AREA[0][10]['FF'] = 27840
  CR_AREA[0][11]['FF'] = 29760
  CR_AREA[0][12]['FF'] = 29760
  CR_AREA[0][13]['FF'] = 29760
  CR_AREA[0][14]['FF'] = 27840
  CR_AREA[1][0 ]['FF'] = 21120
  CR_AREA[1][1 ]['FF'] = 23040
  CR_AREA[1][2 ]['FF'] = 23040
  CR_AREA[1][3 ]['FF'] = 23040
  CR_AREA[1][4 ]['FF'] = 21120
  CR_AREA[1][5 ]['FF'] = 21120
  CR_AREA[1][6 ]['FF'] = 23040
  CR_AREA[1][7 ]['FF'] = 23040
  CR_AREA[1][8 ]['FF'] = 23040
  CR_AREA[1][9 ]['FF'] = 21120
  CR_AREA[1][10]['FF'] = 21120
  CR_AREA[1][11]['FF'] = 23040
  CR_AREA[1][12]['FF'] = 23040
  CR_AREA[1][13]['FF'] = 23040
  CR_AREA[1][14]['FF'] = 21120
  CR_AREA[2][0 ]['FF'] = 29760
  CR_AREA[2][1 ]['FF'] = 31680
  CR_AREA[2][2 ]['FF'] = 31680
  CR_AREA[2][3 ]['FF'] = 31680
  CR_AREA[2][4 ]['FF'] = 29760
  CR_AREA[2][5 ]['FF'] = 29760
  CR_AREA[2][6 ]['FF'] = 31680
  CR_AREA[2][7 ]['FF'] = 31680
  CR_AREA[2][8 ]['FF'] = 31680
  CR_AREA[2][9 ]['FF'] = 29760
  CR_AREA[2][10]['FF'] = 29760
  CR_AREA[2][11]['FF'] = 31680
  CR_AREA[2][12]['FF'] = 31680
  CR_AREA[2][13]['FF'] = 31680
  CR_AREA[2][14]['FF'] = 29760
  CR_AREA[3][0 ]['FF'] = 21120
  CR_AREA[3][1 ]['FF'] = 23040
  CR_AREA[3][2 ]['FF'] = 23040
  CR_AREA[3][3 ]['FF'] = 23040
  CR_AREA[3][4 ]['FF'] = 21120
  CR_AREA[3][5 ]['FF'] = 21120
  CR_AREA[3][6 ]['FF'] = 23040
  CR_AREA[3][7 ]['FF'] = 23040
  CR_AREA[3][8 ]['FF'] = 23040
  CR_AREA[3][9 ]['FF'] = 21120
  CR_AREA[3][10]['FF'] = 21120
  CR_AREA[3][11]['FF'] = 23040
  CR_AREA[3][12]['FF'] = 23040
  CR_AREA[3][13]['FF'] = 23040
  CR_AREA[3][14]['FF'] = 21120
  CR_AREA[4][0 ]['FF'] = 26880
  CR_AREA[4][1 ]['FF'] = 28800
  CR_AREA[4][2 ]['FF'] = 28800
  CR_AREA[4][3 ]['FF'] = 28800
  CR_AREA[4][4 ]['FF'] = 26880
  CR_AREA[4][5 ]['FF'] = 26880
  CR_AREA[4][6 ]['FF'] = 28800
  CR_AREA[4][7 ]['FF'] = 28800
  CR_AREA[4][8 ]['FF'] = 28800
  CR_AREA[4][9 ]['FF'] = 26880
  CR_AREA[4][10]['FF'] = 26880
  CR_AREA[4][11]['FF'] = 28800
  CR_AREA[4][12]['FF'] = 28800
  CR_AREA[4][13]['FF'] = 28800
  CR_AREA[4][14]['FF'] = 26880
  CR_AREA[5][0 ]['FF'] = 24000
  CR_AREA[5][1 ]['FF'] = 25920
  CR_AREA[5][2 ]['FF'] = 25920
  CR_AREA[5][3 ]['FF'] = 25920
  CR_AREA[5][4 ]['FF'] = 24000
  CR_AREA[5][5 ]['FF'] = 24000
  CR_AREA[5][6 ]['FF'] = 25920
  CR_AREA[5][7 ]['FF'] = 25920
  CR_AREA[5][8 ]['FF'] = 25920
  CR_AREA[5][9 ]['FF'] = 24000
  CR_AREA[5][10]['FF'] = 24000
  CR_AREA[5][11]['FF'] = 25920
  CR_AREA[5][12]['FF'] = 25920
  CR_AREA[5][13]['FF'] = 25920
  CR_AREA[5][14]['FF'] = 24000
  
  ################
  
  CR_AREA[0][0 ]['LUT'] = 13920
  CR_AREA[0][1 ]['LUT'] = 14880
  CR_AREA[0][2 ]['LUT'] = 14880
  CR_AREA[0][3 ]['LUT'] = 14880
  CR_AREA[0][4 ]['LUT'] = 13920
  CR_AREA[0][5 ]['LUT'] = 13920
  CR_AREA[0][6 ]['LUT'] = 14880
  CR_AREA[0][7 ]['LUT'] = 14880
  CR_AREA[0][8 ]['LUT'] = 14880
  CR_AREA[0][9 ]['LUT'] = 13920
  CR_AREA[0][10]['LUT'] = 13920
  CR_AREA[0][11]['LUT'] = 14880
  CR_AREA[0][12]['LUT'] = 14880
  CR_AREA[0][13]['LUT'] = 14880
  CR_AREA[0][14]['LUT'] = 13920
  CR_AREA[1][0 ]['LUT'] = 10560
  CR_AREA[1][1 ]['LUT'] = 11520
  CR_AREA[1][2 ]['LUT'] = 11520
  CR_AREA[1][3 ]['LUT'] = 11520
  CR_AREA[1][4 ]['LUT'] = 10560
  CR_AREA[1][5 ]['LUT'] = 10560
  CR_AREA[1][6 ]['LUT'] = 11520
  CR_AREA[1][7 ]['LUT'] = 11520
  CR_AREA[1][8 ]['LUT'] = 11520
  CR_AREA[1][9 ]['LUT'] = 10560
  CR_AREA[1][10]['LUT'] = 10560
  CR_AREA[1][11]['LUT'] = 11520
  CR_AREA[1][12]['LUT'] = 11520
  CR_AREA[1][13]['LUT'] = 11520
  CR_AREA[1][14]['LUT'] = 10560
  CR_AREA[2][0 ]['LUT'] = 14880
  CR_AREA[2][1 ]['LUT'] = 15840
  CR_AREA[2][2 ]['LUT'] = 15840
  CR_AREA[2][3 ]['LUT'] = 15840
  CR_AREA[2][4 ]['LUT'] = 14880
  CR_AREA[2][5 ]['LUT'] = 14880
  CR_AREA[2][6 ]['LUT'] = 15840
  CR_AREA[2][7 ]['LUT'] = 15840
  CR_AREA[2][8 ]['LUT'] = 15840
  CR_AREA[2][9 ]['LUT'] = 14880
  CR_AREA[2][10]['LUT'] = 14880
  CR_AREA[2][11]['LUT'] = 15840
  CR_AREA[2][12]['LUT'] = 15840
  CR_AREA[2][13]['LUT'] = 15840
  CR_AREA[2][14]['LUT'] = 14880
  CR_AREA[3][0 ]['LUT'] = 10560
  CR_AREA[3][1 ]['LUT'] = 11520
  CR_AREA[3][2 ]['LUT'] = 11520
  CR_AREA[3][3 ]['LUT'] = 11520
  CR_AREA[3][4 ]['LUT'] = 10560
  CR_AREA[3][5 ]['LUT'] = 10560
  CR_AREA[3][6 ]['LUT'] = 11520
  CR_AREA[3][7 ]['LUT'] = 11520
  CR_AREA[3][8 ]['LUT'] = 11520
  CR_AREA[3][9 ]['LUT'] = 10560
  CR_AREA[3][10]['LUT'] = 10560
  CR_AREA[3][11]['LUT'] = 11520
  CR_AREA[3][12]['LUT'] = 11520
  CR_AREA[3][13]['LUT'] = 11520
  CR_AREA[3][14]['LUT'] = 10560
  CR_AREA[4][0 ]['LUT'] = 13440
  CR_AREA[4][1 ]['LUT'] = 14400
  CR_AREA[4][2 ]['LUT'] = 14400
  CR_AREA[4][3 ]['LUT'] = 14400
  CR_AREA[4][4 ]['LUT'] = 13440
  CR_AREA[4][5 ]['LUT'] = 13440
  CR_AREA[4][6 ]['LUT'] = 14400
  CR_AREA[4][7 ]['LUT'] = 14400
  CR_AREA[4][8 ]['LUT'] = 14400
  CR_AREA[4][9 ]['LUT'] = 13440
  CR_AREA[4][10]['LUT'] = 13440
  CR_AREA[4][11]['LUT'] = 14400
  CR_AREA[4][12]['LUT'] = 14400
  CR_AREA[4][13]['LUT'] = 14400
  CR_AREA[4][14]['LUT'] = 13440
  CR_AREA[5][0 ]['LUT'] = 12000
  CR_AREA[5][1 ]['LUT'] = 12960
  CR_AREA[5][2 ]['LUT'] = 12960
  CR_AREA[5][3 ]['LUT'] = 12960
  CR_AREA[5][4 ]['LUT'] = 12000
  CR_AREA[5][5 ]['LUT'] = 12000
  CR_AREA[5][6 ]['LUT'] = 12960
  CR_AREA[5][7 ]['LUT'] = 12960
  CR_AREA[5][8 ]['LUT'] = 12960
  CR_AREA[5][9 ]['LUT'] = 12000
  CR_AREA[5][10]['LUT'] = 12000
  CR_AREA[5][11]['LUT'] = 12960
  CR_AREA[5][12]['LUT'] = 12960
  CR_AREA[5][13]['LUT'] = 12960
  CR_AREA[5][14]['LUT'] = 12000
  ...
  CR_AREA[0][8 ]['DSP'] = 120
  CR_AREA[0][9 ]['DSP'] = 120
  CR_AREA[0][10]['DSP'] = 120
  CR_AREA[0][11]['DSP'] = 120
  CR_AREA[0][12]['DSP'] = 120
  CR_AREA[0][13]['DSP'] = 120
  CR_AREA[0][14]['DSP'] = 120
  CR_AREA[1][0 ]['DSP'] = 72
  CR_AREA[1][1 ]['DSP'] = 72
  CR_AREA[1][2 ]['DSP'] = 72
  CR_AREA[1][3 ]['DSP'] = 72
  ...
  CR_AREA[0][0 ]['BRAM'] = 36 * 2
  CR_AREA[0][1 ]['BRAM'] = 36 * 2
  CR_AREA[0][2 ]['BRAM'] = 36 * 2
  CR_AREA[0][3 ]['BRAM'] = 36 * 2
  CR_AREA[0][4 ]['BRAM'] = 36 * 2
  CR_AREA[0][5 ]['BRAM'] = 36 * 2
  CR_AREA[0][6 ]['BRAM'] = 36 * 2
  CR_AREA[0][7 ]['BRAM'] = 36 * 2
  CR_AREA[0][8 ]['BRAM'] = 36 * 2
  CR_AREA[0][9 ]['BRAM'] = 36 * 2
  CR_AREA[0][10]['BRAM'] = 36 * 2
  CR_AREA[0][11]['BRAM'] = 36 * 2
  CR_AREA[0][12]['BRAM'] = 36 * 2
  CR_AREA[0][13]['BRAM'] = 36 * 2
  CR_AREA[0][14]['BRAM'] = 36 * 2
  CR_AREA[1][0 ]['BRAM'] = 12 * 2
  CR_AREA[1][1 ]['BRAM'] = 12 * 2
  CR_AREA[1][2 ]['BRAM'] = 12 * 2
  CR_AREA[1][3 ]['BRAM'] = 12 * 2
  CR_AREA[1][4 ]['BRAM'] = 12 * 2
  CR_AREA[1][5 ]['BRAM'] = 12 * 2
  CR_AREA[1][6 ]['BRAM'] = 12 * 2
  CR_AREA[1][7 ]['BRAM'] = 12 * 2
  CR_AREA[1][8 ]['BRAM'] = 12 * 2
  CR_AREA[1][9 ]['BRAM'] = 12 * 2
  CR_AREA[1][10]['BRAM'] = 12 * 2
  CR_AREA[1][11]['BRAM'] = 12 * 2
  CR_AREA[1][12]['BRAM'] = 12 * 2
  CR_AREA[1][13]['BRAM'] = 12 * 2
  CR_AREA[1][14]['BRAM'] = 12 * 2
  CR_AREA[2][0 ]['BRAM'] = 36 * 2
  CR_AREA[2][1 ]['BRAM'] = 36 * 2
  CR_AREA[2][2 ]['BRAM'] = 36 * 2
  CR_AREA[2][3 ]['BRAM'] = 36 * 2
  ...
  CR_AREA[2][10]['BRAM'] = 36 * 2
  CR_AREA[2][11]['BRAM'] = 36 * 2
  CR_AREA[2][12]['BRAM'] = 36 * 2
  CR_AREA[2][13]['BRAM'] = 36 * 2
  CR_AREA[2][14]['BRAM'] = 36 * 2
  CR_AREA[3][0 ]['BRAM'] = 12 * 2
  CR_AREA[3][1 ]['BRAM'] = 12 * 2
  CR_AREA[3][2 ]['BRAM'] = 12 * 2
  CR_AREA[3][3 ]['BRAM'] = 12 * 2
  ...
  CR_AREA[3][10]['BRAM'] = 12 * 2
  CR_AREA[3][11]['BRAM'] = 12 * 2
  CR_AREA[3][12]['BRAM'] = 12 * 2
  CR_AREA[3][13]['BRAM'] = 12 * 2
  CR_AREA[3][14]['BRAM'] = 12 * 2
  CR_AREA[4][0 ]['BRAM'] = 24 * 2
  CR_AREA[4][1 ]['BRAM'] = 24 * 2
  CR_AREA[4][2 ]['BRAM'] = 24 * 2
  CR_AREA[4][3 ]['BRAM'] = 24 * 2
  ...
  CR_AREA[4][10]['BRAM'] = 24 * 2
  CR_AREA[4][11]['BRAM'] = 24 * 2
  CR_AREA[4][12]['BRAM'] = 24 * 2
  CR_AREA[4][13]['BRAM'] = 24 * 2
  CR_AREA[4][14]['BRAM'] = 24 * 2
  CR_AREA[5][0 ]['BRAM'] = 24 * 2
  CR_AREA[5][1 ]['BRAM'] = 24 * 2
  CR_AREA[5][2 ]['BRAM'] = 24 * 2
  CR_AREA[5][3 ]['BRAM'] = 24 * 2
  CR_AREA[5][4 ]['BRAM'] = 24 * 2
  CR_AREA[5][5 ]['BRAM'] = 24 * 2
  CR_AREA[5][6 ]['BRAM'] = 24 * 2
  CR_AREA[5][7 ]['BRAM'] = 24 * 2
  CR_AREA[5][8 ]['BRAM'] = 24 * 2
  CR_AREA[5][9 ]['BRAM'] = 24 * 2
  CR_AREA[5][10]['BRAM'] = 24 * 2
  CR_AREA[5][11]['BRAM'] = 24 * 2
  CR_AREA[5][12]['BRAM'] = 24 * 2
  CR_AREA[5][13]['BRAM'] = 24 * 2
  CR_AREA[5][14]['BRAM'] = 24 * 2
  ...
  CR_AREA[1][10]['URAM'] = 16
  CR_AREA[1][11]['URAM'] = 16
  CR_AREA[1][12]['URAM'] = 16
  CR_AREA[1][13]['URAM'] = 16
  CR_AREA[1][14]['URAM'] = 16
  CR_AREA[2][0 ]['URAM'] = 16
  CR_AREA[2][1 ]['URAM'] = 16
  CR_AREA[2][2 ]['URAM'] = 16
  CR_AREA[2][3 ]['URAM'] = 16
  ...
  CR_AREA[2][8 ]['URAM'] = 16
  CR_AREA[2][9 ]['URAM'] = 16
  CR_AREA[2][10]['URAM'] = 16
  CR_AREA[2][11]['URAM'] = 16
  CR_AREA[2][12]['URAM'] = 16
  CR_AREA[2][13]['URAM'] = 16
  CR_AREA[2][14]['URAM'] = 16
  CR_AREA[3][0 ]['URAM'] = 16
  CR_AREA[3][1 ]['URAM'] = 16
  CR_AREA[3][2 ]['URAM'] = 16
  CR_AREA[3][3 ]['URAM'] = 16
  ...
  CR_AREA[3][10]['URAM'] = 16
  CR_AREA[3][11]['URAM'] = 16
  CR_AREA[3][12]['URAM'] = 16
  CR_AREA[3][13]['URAM'] = 16
  CR_AREA[3][14]['URAM'] = 16
  CR_AREA[4][0 ]['URAM'] = 16
  CR_AREA[4][1 ]['URAM'] = 16
  CR_AREA[4][2 ]['URAM'] = 16
  CR_AREA[4][3 ]['URAM'] = 16
  ...
  CR_AREA[4][10]['URAM'] = 16
  CR_AREA[4][11]['URAM'] = 16
  CR_AREA[4][12]['URAM'] = 16
  CR_AREA[4][13]['URAM'] = 16
  CR_AREA[4][14]['URAM'] = 16
  CR_AREA[5][0 ]['URAM'] = 0
  CR_AREA[5][1 ]['URAM'] = 0
  CR_AREA[5][2 ]['URAM'] = 0
  CR_AREA[5][3 ]['URAM'] = 0
  ...
  # assertions to check if it adds up
  # for item in ('BRAM', 'DSP', 'FF', 'LUT', 'URAM'):
  #   sum = 0
  #   for x in range(CR_NUM_HORIZONTAL):
  #     for y in range(CR_NUM_VERTICAL):
  #       sum += CR_AREA[x][y][item]
  #   assert TOTAL_AREA[item] == sum

class DeviceU50(DeviceBase):
  NAME = 'U50'
  FPGA_PART_NAME = 'xcu50-fsvh2104-2-e'
  ...
  CR_NUM_VERTICAL_ACTUAL = 8

  VITIS_REGION = f'CLOCKREGION_X6Y0:CLOCKREGION_X7Y6'
  ...
  # Clock Region level
  CR_AREA = defaultdict(lambda: defaultdict(lambda: defaultdict(lambda: 0)))
  CR_AREA[0][0 ]['FF'] = 29760
  CR_AREA[0][1 ]['FF'] = 29760
  CR_AREA[0][2 ]['FF'] = 29760
  CR_AREA[0][3 ]['FF'] = 27840
  ...
  for x in range(CR_NUM_HORIZONTAL):
    for y in range(CR_NUM_VERTICAL_ACTUAL):
      TOTAL_AREA['BRAM'] += CR_AREA[x][y]['BRAM']
      TOTAL_AREA['URAM'] += CR_AREA[x][y]['URAM']
      TOTAL_AREA['LUT'] += CR_AREA[x][y]['LUT']
      TOTAL_AREA['DSP'] += CR_AREA[x][y]['DSP']
      TOTAL_AREA['FF'] += CR_AREA[x][y]['FF']
...
class DeviceManager:
  def __init__(self, board_name, ddr_list = [], is_vitis_enabled = False):
    if board_name == 'U250':
      ...
      self.board = DeviceU200(ddr_list, is_vitis_enabled)
    elif board_name == 'U50':
      self.board = DeviceU50(ddr_list, is_vitis_enabled)
    else:
