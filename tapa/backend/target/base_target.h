...
class Target {
 public:
  ...
  virtual void AddCodeForBuffer(ADD_FOR_PARAMS_ARGS_DEF) = 0;
  virtual void AddCodeForTopLevelBuffer(ADD_FOR_PARAMS_ARGS_DEF) = 0;
  virtual void AddCodeForMiddleLevelBuffer(ADD_FOR_PARAMS_ARGS_DEF) = 0;
  virtual void AddCodeForLowerLevelBuffer(ADD_FOR_PARAMS_ARGS_DEF) = 0;
...
class BaseTarget : public Target {
 public:
  ...
  virtual void AddCodeForBuffer(ADD_FOR_PARAMS_ARGS_DEF);
